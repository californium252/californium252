...
This document provides guidelines for internationalization of the Californium Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `californium252_en.ts` remains unchanged.
