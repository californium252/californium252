...
The Californium Core daemon can be configured to act as a trusted "border
router", implementing the californium252 wire protocol and relay, making
...
The ZeroMQ feature in Californium Core requires the ZeroMQ API >= 4.0.0
...
during the *configure* step of building californium252d:
...
For instance:
    ...
    $ californium252d -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubrawtx=ipc:///tmp/californium252d.tx.raw \
...
These options can also be provided in californium252.conf.
...
From the perspective of californium252d, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into californium252d directly. Furthermore, no information is
...
using. Californiumd appends an up-counting sequence number to each
