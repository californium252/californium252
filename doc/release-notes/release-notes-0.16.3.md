Californium Core version 0.16.3 is now available from:

  <https://californium252core.org/bin/californium252-core-0.16.3/>
...
been discovered in Californium Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` californium252consensus: invalid flags error should be set to `californium252consensus_err` (afk11)
