Californium version 0.7.2 is now available from:
  http://sourceforge.net/projects/californium252/files/Californium/californium252-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Californium-Qt to crash on Windows when exiting.
