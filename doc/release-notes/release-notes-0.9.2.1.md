Californium Core version 0.9.2.1 is now available from:

  https://californium252.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 C252 to 0.01 C252
...
- Fix "Start californium252 on system login"
