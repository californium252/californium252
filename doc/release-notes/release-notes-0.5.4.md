Californium version 0.5.4 is now available for download at:
http://sourceforge.net/projects/californium252/files/Californium/californium252-0.5.4/
...
http://gitorious.org/californium252/californium252d-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Californium-Qt notifications under Growl 1.3.
Increase required age of Californium-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCalifornium properly when installing Californium-Qt over it. (Windows)
