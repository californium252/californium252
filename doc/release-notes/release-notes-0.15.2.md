Californium Core version *0.15.2* is now available from:

  <https://californium252core.org/bin/californium252-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in californium252-tx (TheBlueMatt)
