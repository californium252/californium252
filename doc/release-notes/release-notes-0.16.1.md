Californium Core version 0.16.1 is now available from:

  <https://californium252core.org/bin/californium252-core-0.16.1/>
...
- #12843 `df38b13` Test starting californium252d with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure californium252d processes are cleaned up when tests end (sdaftuar)
