Californium Core version 0.10.4 is now available from:

  <https://californium252.org/bin/californium252-core-0.10.4/>
...
- #6953 `43c2789` Split californium252-tx into its own package
- #6953 `dfe0d4d` Include californium252-tx binary on Debian/Ubuntu
