Californium Core version 0.9.4 is now available from:

  https://californium252.org/bin/0.9.4/
...
this update is incompatible with the Californium system and could lead to consensus
forks.

Californium Core released binaries from https://californium252.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~californium252/+archive/ubuntu/californium252
- A third-party or self-compiled Californium Core

upgrade to Californium Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
