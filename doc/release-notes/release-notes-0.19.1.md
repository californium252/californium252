...
Californium Core version 0.19.1 is now available from:

  <https://californium252core.org/bin/californium252-core-0.19.1/>
...
From Californium Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Californium Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Californium Core does not yet change appearance when
...
- #17488 fix "californium252d already running" warnings on macOS (fanquake)
