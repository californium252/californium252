...
# Deterministically build Californium Core
...
INFO: Building commit ${GIT_COMMIT:?not set} for platform triple ${HOST:?not set}:
      ...
      ...from worktree directory: '${PWD}'
          ...bind-mounted in container to: '/californium252'
...
EOF
        ...
        #     same exact path (e.g. mapping '/home/satoshi/californium252/' to
        #     '/home/satoshi/californium252/'). This means that the $PWD inside the
        ...
        #                      according to SPEC
        #
        #   --share="$PWD"=/californium252
        #
        #                     maps our current working directory to /californium252
        ...
        #     container so that we have something to build. '/californium252' was
        #     chosen arbitrarily.
        #
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                        ...
                                        OUTDIR=/outdir \
                                      bash -c "cd /californium252 && bash contrib/guix/libexec/build.sh"
    )
