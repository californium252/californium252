...
EXCLUDE = [
    # auto generated:
    'src/qt/californium252strings.cpp',
...
EXPECTED_HOLDER_NAMES = [
    r"Satoshi Nakamoto",
    r"The Californium Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a californium252 source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Californium Core developers'
...
CPP_HEADER = '''
// Copyright (c) %s The Californium Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The Californium Core developers'
                 % (filename))
...
Arguments:
    <file> - A source file in the californium252 repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Californium
