...
def main():
    ...
    # Filter out hosts with multiple californium252 ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple californium252 ports' % (ip_stats(ips)), file=sys.stderr)
