...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the californium252 repository."
  exit 1
fi
...
# See https://github.com/californium252/californium252/issues/16064
...
echo 'When compiling californium252d, run `./configure` in the following way:'
echo
