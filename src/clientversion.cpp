 ...
 * for both californium252d and californium252-qt, to make it harder for attackers to
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/californium252/bips/blob/master/bip-0014.mediawiki)
 */
