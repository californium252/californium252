...
#ifndef CALIFORNIUM_COMPAT_ASSUMPTIONS_H
#define CALIFORNIUM_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Californium cannot be compiled without assertions."
#endif
...
#endif // CALIFORNIUM_COMPAT_ASSUMPTIONS_H
