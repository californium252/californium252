...
#ifndef CALIFORNIUM_UTIL_MESSAGE_H
#define CALIFORNIUM_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's californium252 address, it must refer to a public key.
...
#endif // CALIFORNIUM_UTIL_MESSAGE_H
