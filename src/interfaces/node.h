...
#ifndef CALIFORNIUM_INTERFACES_NODE_H
#define CALIFORNIUM_INTERFACES_NODE_H
...
//! Top-level interface for a californium252 node (californium252d process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // CALIFORNIUM_INTERFACES_NODE_H
