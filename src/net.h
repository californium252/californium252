...
#ifndef CALIFORNIUM_NET_H
#define CALIFORNIUM_NET_H
...
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Californium’s Peer-to-Peer Network")
