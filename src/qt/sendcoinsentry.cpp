    ...
    platformStyle(_platformStyle)
{
    ...
    // normal californium252 address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying californium252 address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &CaliforniumAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
