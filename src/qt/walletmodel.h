...
#ifndef CALIFORNIUM_QT_WALLETMODEL_H
#define CALIFORNIUM_QT_WALLETMODEL_H
...
/** Interface to Californium wallet from Qt view code. */
...
#endif // CALIFORNIUM_QT_WALLETMODEL_H
