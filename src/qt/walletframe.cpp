...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, CaliforniumGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &CaliforniumGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &CaliforniumGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &CaliforniumGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &CaliforniumGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &CaliforniumGUI::updateWalletStatus);
    connect(gui, &CaliforniumGUI::setPrivacy, walletView, &WalletView::setPrivacy);
