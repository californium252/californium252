...
//! Entry point for CaliforniumApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &CaliforniumApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for CaliforniumGUI tests.
void AppTests::guiTests(CaliforniumGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &CaliforniumGUI::consoleShown, this, &AppTests::consoleTests);
