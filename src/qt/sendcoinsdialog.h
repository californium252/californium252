...
#ifndef CALIFORNIUM_QT_SENDCOINSDIALOG_H
#define CALIFORNIUM_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending californium252s */
...
#endif // CALIFORNIUM_QT_SENDCOINSDIALOG_H
