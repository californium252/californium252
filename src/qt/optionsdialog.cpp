    ...
    mapper(nullptr)
{
    ...
    ui->californium252AtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->californium252AtStartup);
    ...
    ui->californium252AtStartup->setToolTip(ui->californium252AtStartup->toolTip().arg(PACKAGE_NAME));
    ui->californium252AtStartup->setText(ui->californium252AtStartup->text().arg(PACKAGE_NAME));

    ui->openCaliforniumConfButton->setToolTip(ui->openCaliforniumConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new CaliforniumUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->californium252AtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openCaliforniumConfButton_clicked()
{
    ...
    if (!GUIUtil::openCaliforniumConf())
