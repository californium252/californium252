// Copyright (c) 2015-2018 The Californium Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef CALIFORNIUM_CORE_MEMUSAGE_H
#define CALIFORNIUM_CORE_MEMUSAGE_H
...
#endif // CALIFORNIUM_CORE_MEMUSAGE_H
