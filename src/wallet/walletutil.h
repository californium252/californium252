...
#ifndef CALIFORNIUM_WALLET_WALLETUTIL_H
#define CALIFORNIUM_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! californium252 from opening the wallet, thinking it was newly created, and
...
#endif // CALIFORNIUM_WALLET_WALLETUTIL_H
