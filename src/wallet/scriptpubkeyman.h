...
#ifndef CALIFORNIUM_WALLET_SCRIPTPUBKEYMAN_H
#define CALIFORNIUM_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Californium Core wallet was originally a collection of unrelated private
...
#endif // CALIFORNIUM_WALLET_SCRIPTPUBKEYMAN_H
