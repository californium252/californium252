...
#ifndef CALIFORNIUM_WALLET_WALLET_H
#define CALIFORNIUM_WALLET_WALLET_H
...
public:
     ...
     * on this californium252 node, and set to 0 for transactions that were created
...
#endif // CALIFORNIUM_WALLET_WALLET_H
