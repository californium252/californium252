...
#ifndef CALIFORNIUM_SCRIPT_SCRIPT_H
#define CALIFORNIUM_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Californium always counted CHECKMULTISIGs
...
#endif // CALIFORNIUM_SCRIPT_SCRIPT_H
