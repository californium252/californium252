...
#ifndef CALIFORNIUM_TEST_SCRIPTNUM10_H
#define CALIFORNIUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Californium Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // CALIFORNIUM_TEST_BIGNUM_H
