...
#ifndef CALIFORNIUM_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define CALIFORNIUM_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // CALIFORNIUM_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
