...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the CaliforniumTestFramework
    pass


class ExampleTest(CaliforniumTestFramework):
    # Each functional test is a subclass of the CaliforniumTestFramework class.
    ...
    def custom_method(self):
        ...
        CaliforniumTestFramework class so other tests can use it."""
