...
class TestShell:
    """Wrapper Class for CaliforniumTestFramework.

    The TestShell class extends the CaliforniumTestFramework
    ...
    class __TestShell(CaliforniumTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by CaliforniumTestFramework child class.
            self.num_nodes = 1
