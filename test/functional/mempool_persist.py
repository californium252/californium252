...
By default, californium252d will dump mempool on shutdown and
...
class MempoolPersistTest(CaliforniumTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent californium252d from writing mempool.dat to disk. Verify that `savemempool` fails")
