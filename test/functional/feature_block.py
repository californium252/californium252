...
class FullBlockTest(CaliforniumTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure californium252d isn't accepting b26
        ...
        # Extend the b28 chain to make sure californium252d isn't accepting b28
        ...
        # californium252d doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the californium252 code has custom code which does so);
