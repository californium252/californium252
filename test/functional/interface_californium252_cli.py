...
# The block reward of coinbaseoutput.nValue (50) C252/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 C252/block.
BLOCKS = 101
...
class TestCaliforniumCli(CaliforniumTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `californium252-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and californium252-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 C252) to the default wallet.
            ...
            # Test californium252-cli -generate.
            n1 = 3
            n2 = 4
            ...
            # Test californium252-cli -generate with -rpcwallet in multiwallet mode.
