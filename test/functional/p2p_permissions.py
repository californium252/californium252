...
class P2PPermissionsTests(CaliforniumTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].californium252conf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].californium252conf, 'w', encoding="utf8") as f:
            f.write(newText)
