...
"""Verify that starting californium252 with -h works as expected."""

from test_framework.test_framework import CaliforniumTestFramework
from test_framework.util import assert_equal

class HelpTest(CaliforniumTestFramework):
    ...
    def run_test(self):
        self.log.info("Start californium252 with -h for help text")
        ...
        self.log.info("Start californium252 with -version for version information")
        ...
        self.log.info("Start californium252d with -fakearg to make sure it does not start")
