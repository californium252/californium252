...
# TestP2PConn: A peer we use to send messages to californium252d, and store responses.
...
class CompactBlocksTest(CaliforniumTestFramework):
    ...
    # This test actually causes californium252d to (reasonably!) disconnect us, so do this last.
    ...
    # californium252d's choice of nonce.
    ...
    # Test that californium252d requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for californium252d to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # californium252d will not send blocktxn responses for blocks whose height is
