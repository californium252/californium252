...
class SegWitTest(CaliforniumTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older californium252d's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let californium252d fill it in.
