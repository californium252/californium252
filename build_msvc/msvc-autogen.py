...
libs = [
    'libcalifornium252_cli',
    'libcalifornium252_common',
    'libcalifornium252_crypto',
    'libcalifornium252_server',
    'libcalifornium252_util',
    'libcalifornium252_wallet_tool',
    'libcalifornium252_wallet',
    'libcalifornium252_zmq',
    'bench_californium252',
    'libtest_util',
]
...
def main():
    parser = argparse.ArgumentParser(description='Californium-core msbuild configuration initialiser.')
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/californium252_config.h'), os.path.join(SOURCE_DIR, 'config/californium252-config.h'))
