...
// californium252 includes.
#include <..\src\script\californium252consensus.h>
...
int main()
{
    std::cout << "californium252consensus version: " << californium252consensus_version() << std::endl;
    ...
    auto op0Result = californium252consensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, californium252consensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
