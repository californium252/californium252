...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Californium
else
  DOCKER_EXEC echo \> \$HOME/.californium252
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/californium252/californium252/pull/18288#discussion_r433189350 for
  # details.
